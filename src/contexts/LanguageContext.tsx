...
const translations = {
  "sr-latin": {
    ...
    "join.recreational.note": "Trenutno aktivna! Prihvatamo sve koji žele da se pridruže - jednostavno dođite bilo koje veče. Svi su dobrodošli, uključujući starije. Što nas je više, to je veselije!",
  ...
  "sr-cyrillic": {
    ...
    "join.recreational.note": "Тренутно активна! Прихватамо све који желе да се придруже - једноставно дођите било које вече. Сви су добродошли, укључујући старије. Што нас је више, то је веселије!",
  ...
  en: {
    ...
    "join.recreational.note": "Currently running! Accepting anyone who wants to join - simply walk in any night. All are welcome including seniors. The more the merrier!",
