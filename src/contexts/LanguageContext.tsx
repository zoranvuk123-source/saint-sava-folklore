...
const translations = {
  "sr-latin": {
    ...
    "sponsorships.levels.title": "Mogućnosti Partnerstva",
    "sponsorships.levels.subtitle": "Izaberite nivo koji vam najbolje odgovara i postanite deo naše priče",
    "sponsorships.bronze.title": "Bronzani Partner",
    "sponsorships.bronze.marketing": "Ime navedeno u programu događaja.",
    "sponsorships.bronze.experience": "2 karte za opšti prijem i večera",
    "sponsorships.silver.title": "Srebrni Partner",
    "sponsorships.silver.marketing": "Logo na veb sajtu i u programu događaja; četvrtstranični oglas u programu.",
    "sponsorships.silver.experience": "2 VIP karte i večera",
    "sponsorships.gold.title": "Zlatni Partner",
    "sponsorships.gold.marketing": "Logo na veb sajtu događaja i društvenim mrežama; polustranični oglas u programu; signalizacija na događaju.",
    "sponsorships.gold.experience": "4 VIP karte i večera",
    "sponsorships.platinum.title": "Glavni Partner",
    "sponsorships.platinum.marketing": "Logo na pozivnicama, veb sajtu i društvenim mrežama; celostranični oglas u programu; istaknuta signalizacija na događaju.",
    "sponsorships.platinum.experience": "8 VIP karata i večera za ceo sto",
    "sponsorships.col.level": "Nivo",
    "sponsorships.col.investment": "Investicija",
    "sponsorships.col.marketing": "Marketing i Vidljivost",
    "sponsorships.col.experience": "Doživite Veče",
    "sponsorships.download.letter": "Preuzmite Sponzorsko Pismo",
    "sponsorships.event.title": "Prolećna Folkorama: Nasleđe u Pokretu",
    "sponsorships.event.date": "Subota, 25. april 2026.",
    "sponsorships.event.description": "Događaj koji okuplja sledeću generaciju talenta i kulture. Pozivamo vas da predstavite svoj brend pred više od 800 posetilaca i 16 plesnih grupa iz Kanade i SAD-a.",
    ...
    "sponsorships.tax.info": "Folklorna Grupa Sveti Sava Oplenac je neprofitna, volonterska organizacija. Molimo kontaktirajte nas za više informacija.",
  ...
  "sr-cyrillic": {
    ...
    "sponsorships.levels.title": "Могућности Партнерства",
    "sponsorships.levels.subtitle": "Изаберите ниво који вам најбоље одговара и постаните део наше приче",
    "sponsorships.bronze.title": "Бронзани Партнер",
    "sponsorships.bronze.marketing": "Име наведено у програму догађаја.",
    "sponsorships.bronze.experience": "2 карте за општи пријем и вечера",
    "sponsorships.silver.title": "Сребрни Партнер",
    "sponsorships.silver.marketing": "Лого на веб сајту и у програму догађаја; четвртстранични оглас у програму.",
    "sponsorships.silver.experience": "2 VIP карте и вечера",
    "sponsorships.gold.title": "Златни Партнер",
    "sponsorships.gold.marketing": "Лого на веб сајту догађаја и друштвеним мрежама; полустранични оглас у програму; сигнализација на догађају.",
    "sponsorships.gold.experience": "4 VIP карте и вечера",
    "sponsorships.platinum.title": "Главни Партнер",
    "sponsorships.platinum.marketing": "Лого на позивницама, веб сајту и друштвеним мрежама; целостранични оглас у програму; истакнута сигнализација на догађају.",
    "sponsorships.platinum.experience": "8 VIP карата и вечера за цео сто",
    "sponsorships.col.level": "Ниво",
    "sponsorships.col.investment": "Инвестиција",
    "sponsorships.col.marketing": "Маркетинг и Видљивост",
    "sponsorships.col.experience": "Доживите Вече",
    "sponsorships.download.letter": "Преузмите Спонзорско Писмо",
    "sponsorships.event.title": "Пролећна Фолкорама: Наслеђе у Покрету",
    "sponsorships.event.date": "Субота, 25. април 2026.",
    "sponsorships.event.description": "Догађај који окупља следећу генерацију талента и културе. Позивамо вас да представите свој бренд пред више од 800 посетилаца и 16 плесних група из Канаде и САД-а.",
    ...
    "sponsorships.tax.info": "Фолклорна Група Свети Сава Опленац је непрофитна, волонтерска организација. Молимо контактирајте нас за више информација.",
  ...
  en: {
    ...
    "sponsorships.levels.title": "Partnership Opportunities",
    "sponsorships.levels.subtitle": "Choose the level that works best for you and become part of our story",
    "sponsorships.bronze.title": "Bronze Partner",
    "sponsorships.bronze.marketing": "Name listed in the event program.",
    "sponsorships.bronze.experience": "2 General Admission Tickets & Dinner Service",
    "sponsorships.silver.title": "Silver Partner",
    "sponsorships.silver.marketing": "Logo on website and in the event program; quarter-page program ad.",
    "sponsorships.silver.experience": "2 VIP Tickets & Dinner Service",
    "sponsorships.gold.title": "Gold Partner",
    "sponsorships.gold.marketing": "Logo on event website and social media; half-page program ad; event signage.",
    "sponsorships.gold.experience": "4 VIP Tickets & Dinner Service",
    "sponsorships.platinum.title": "Presenting Partner",
    "sponsorships.platinum.marketing": "Top-tier logo placement on invitations, website, and social media; full-page program ad; prominent event signage.",
    "sponsorships.platinum.experience": "Full Table: 8 VIP Tickets & Dinner Service",
    "sponsorships.col.level": "Level",
    "sponsorships.col.investment": "Investment",
    "sponsorships.col.marketing": "Marketing & Visibility",
    "sponsorships.col.experience": "Experience the Evening",
    "sponsorships.download.letter": "Download Sponsorship Letter",
    "sponsorships.event.title": "Spring Folklorama: A Legacy in Motion",
    "sponsorships.event.date": "Saturday, April 25, 2026",
    "sponsorships.event.description": "An event that brings together the next generation of talent and culture. We invite you to showcase your brand to over 800 attendees and 16 dance groups from Canada and the United States.",
    ...
    "sponsorships.tax.info": "Sveti Sava Oplenac Folklorna Grupa is a non-profit, parent-volunteer organization. Please contact us for more information.",
