...
const translations = {
  "sr-latin": {
    ...
    "join.location.description": "Vežbe se održavaju nedeljno u crkvi. Neke vežbe mogu uključiti razgovore i posete sveštenika iz parohije.",
    "join.group3": "Grupa 3",
    "join.group2": "Grupa 2",
    "join.group1": "Grupa 1",
    ...
    "join.group3.time": "Nedeljne vežbe četvrtkom od 5:30 do 6:30 uveče",
    "join.group3.note": "Posle vežbe mogu biti prilike za razgovor sa sveštenicima iz parohije.",
    "join.group2.time": "Nedeljne vežbe četvrtkom od 6:30 do 7:30 uveče",
    "join.group2.note": "Sa horeografom + nastupi po rasporedu. Povremeno mogu biti posete sveštenika.",
    "join.group1.time": "Nedeljne vežbe četvrtkom od 7:30 do 9 uveče",
    "join.group1.note": "+ nastupi po rasporedu. Povremeno mogu biti razgovori sa sveštenicima iz parohije.",
    ...
    "contact.location.directions": "Dobijte Uputstva",
  ...
  "sr-cyrillic": {
    ...
    "join.location.description": "Вежбе се одржавају недељно у цркви. Неке вежбе могу укључити разговоре и посете свештеника из парохије.",
    "join.group3": "Група 3",
    "join.group2": "Група 2",
    "join.group1": "Група 1",
    ...
    "join.group3.time": "Недељне вежбе четвртком од 5:30 до 6:30 увече",
    "join.group3.note": "После вежбе могу бити прилике за разговор са свештеницима из парохије.",
    "join.group2.time": "Недељне вежбе четвртком од 6:30 до 7:30 увече",
    "join.group2.note": "Са хореографом + наступи по распореду. Повремено могу бити посете свештеника.",
    "join.group1.time": "Недељне вежбе четвртком од 7:30 до 9 увече",
    "join.group1.note": "+ наступи по распореду. Повремено могу бити разговори са свештеницима из парохије.",
    ...
    "contact.location.directions": "Добијте Упутства",
  ...
  en: {
    ...
    "join.location.description": "Practices held weekly at the church. Some sessions may include talks and visits from priests from the parish.",
    "join.group3": "Group 3",
    "join.group2": "Group 2",
    "join.group1": "Group 1",
    ...
    "join.group3.time": "Weekly practices Thursdays from 5:30 until 6:30 PM",
    "join.group3.note": "Some sessions may include opportunities for discussions with priests from the parish.",
    "join.group2.time": "Weekly practices Thursdays from 6:30 until 7:30 PM",
    "join.group2.note": "With choreographer + performances as scheduled. Occasional visits from parish priests.",
    "join.group1.time": "Weekly practices Thursdays from 7:30 until 9 PM",
    "join.group1.note": "+ performances as scheduled. Occasional talks with priests from the parish.",
