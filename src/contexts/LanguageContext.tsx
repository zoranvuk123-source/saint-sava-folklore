...
const translations = {
  "sr-latin": {
    ...
    "join.location.title": "Lokacija proba",
    "join.location.church": "Srpski Centar, 2520 Dixie Road",
    "join.location.description": "Probe se održavaju u Srpskom Centru. Ponekad mogu da uključe sesije i razgovore sa sveštenicima iz parohije Hram Sabora Srba Svetitelja Srpska Pravoslavna Crkva koji dolaze u posetu.",
    "join.group3": "Grupa 3",
    "join.group2": "Grupa 2",
    "join.group1": "Grupa 1",
    ...
    "join.group3.note": "Ponekad mogu da uključe sesije i razgovore sa sveštenicima iz parohije koji dolaze u posetu.",
    "join.group2.time": "Četvrtak: 6:30 - 7:30 p.m.",
    "join.group2.note": "Ponekad mogu da uključe sesije i razgovore sa sveštenicima iz parohije koji dolaze u posetu.",
    "join.group1.time": "Četvrtak: 7:30 - 9:30 p.m. | Nedelja: 6:00 - 8:00 p.m.",
    "join.group1.note": "Ponekad mogu da uključe sesije i razgovore sa sveštenicima iz parohije koji dolaze u posetu.",
  ...
  "sr-cyrillic": {
    ...
    "join.location.title": "Локација проба",
    "join.location.church": "Српски Центар, 2520 Dixie Road",
    "join.location.description": "Пробе се одржавају у Српском Центру. Понекад могу да укључе сесије и разговоре са свештеницима из парохије Храм Сабора Срба Светитеља Српска Православна Црква који долазе у посету.",
    "join.group3": "Група 3",
    "join.group2": "Група 2",
    "join.group1": "Група 1",
    ...
    "join.group3.note": "Понекад могу да укључе сесије и разговоре са свештеницима из парохије који долазе у посету.",
    "join.group2.time": "Четвртак: 6:30 - 7:30 p.m.",
    "join.group2.note": "Понекад могу да укључе сесије и разговоре са свештеницима из парохије који долазе у посету.",
    "join.group1.time": "Четвртак: 7:30 - 9:30 p.m. | Недеља: 6:00 - 8:00 p.m.",
    "join.group1.note": "Понекад могу да укључе сесије и разговоре са свештеницима из парохије који долазе у посету.",
