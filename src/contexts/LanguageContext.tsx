...
const translations = {
  "sr-latin": {
    ...
    "join.recreational.note": "Nadamo se da će uskoro početi. Biće otvorena za sve uzraste! Slobodno nas kontaktirajte.",
    ...
    "about.choreographer.tba": "Informacije uskoro.",
    ...
    "community.church.description": "Naša grupa je usko povezana sa Srpskom pravoslavnom crkvom Sveti Sava i učestvuje u crkvenim proslavama.",
  ...
  "sr-cyrillic": {
    ...
    "join.recreational.note": "Надамо се да ће ускоро почети. Биће отворена за све узрасте! Слободно нас контактирајте.",
    ...
    "about.choreographer.tba": "Информације ускоро.",
    ...
    "community.church.description": "Наша група је уско повезана са Српском православном црквом Свети Сава и учествује у црквеним прославама.",
